...
<div class="container shifted">
  ...
  <div class="archiveNav">
    ...
    <a class="tag button" href="https://buymeacoffee.com/uMhxJCzPS" target="_blank" rel="noopener"><IconifyIcon icon={coffeeDuotone} height={20} class="iconify" />Buy Me a Coffee</a>
  </div>
</div>